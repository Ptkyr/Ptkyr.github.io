            ...
            series: [
              {
                ...
                data: [
                    ...
                    {x: 3, y: 94, name: 'CS240', desc: 'Data Structures and Data Management'},
                    ...
                    {x: 6, y: 95, name: 'CS488', desc: 'Introduction to Computer Graphics'},
                ]
            },
            {
                name: '(P)MATH',
                data: [
                    ...
                    {x: 6, y: 99, name: 'PMATH348', desc: 'Fields and Galois Theory'},
                    {x: 6, y: 100, name: 'PMATH445', desc: 'Representations of Finite Groups'},
                ]
            },
            {
                name: 'CO',
                data: [
                    ...
                    {x: 5.9, y: 98, name: 'CO444', desc: 'Algebraic Graph Theory'},
                    {x: 6.1, y: 98, name: 'CO487', desc: 'Applied Cryptography'},
                ]
            },
            {
                name: 'CHEM',
